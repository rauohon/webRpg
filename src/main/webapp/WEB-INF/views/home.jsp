			...
			<div class="col-md-9 col-lg-8 dash-left">
				...
				<div class="panel panel-site-traffic">
					<div class="panel-heading">
						...
						<h4 class="panel-title text-success">How Engaged Our Users
							Daily</h4>
							...
							<div class="panel-body">
								<div class="row">
									<div class="col-xs-7 col-lg-8">
										...
										<h3>75.7%</h3>
										<div class="progress">
											<div style="width: 75.7%" aria-valuemax="100"
												aria-valuemin="0" aria-valuenow="75.7" role="progressbar"
							...
							<div class="panel-body">
								<div class="row">
									<div class="col-xs-7 col-lg-8">
										...
										<h3>39.9%</h3>
										<div class="progress">
											<div style="width: 39.9%" aria-valuemax="100"
												aria-valuemin="0" aria-valuenow="39.9" role="progressbar"
							...
							<div class="panel-body">
								<div class="row">
									<div class="col-xs-7 col-lg-8">
										...
										<h3>55.4%</h3>
										<div class="progress">
											<div style="width: 55.4%" aria-valuemax="100"
												aria-valuemin="0" aria-valuenow="55.4" role="progressbar"
							...
							<div class="panel-body">
								<div class="row">
									<div class="col-xs-7 col-lg-8">
										...
										<h3>22.1%</h3>
										<div class="progress">
											<div style="width: 22.1%" aria-valuemax="100"
												aria-valuemin="0" aria-valuenow="22.1" role="progressbar"
					...
					<div class="col-sm-5 col-md-12 col-lg-6">
						<div class="panel panel-danger panel-weather">
							...
							<div class="panel-body inverse">
								...
								<p class="nomargin">Thunderstorm in the area of
									responsibility this afternoon through this evening.</p>
								<div class="row mt10">
									<div class="col-xs-7">
						...
						<div class="panel panel-primary list-announcement">
							...
							<div class="panel-body">
								<ul class="list-unstyled mb20">
									<li><a href="">Testing Credit Card Payments on...</a> <small>June
											30, 2015 <a href="">7 shares</a>
									</small></li>
									<li><a href="">A Shopping Cart for New and...</a> <small>June
											15, 2015 &nbsp; <a href="">11 shares</a>
									</small></li>
									<li><a href="">A Shopping Cart for New and...</a> <small>June
											15, 2015 &nbsp; <a href="">2 shares</a>
									</small></li>
								</ul>
							</div>
							<div class="panel-footer">
								<button class="btn btn-primary btn-block">
									View More Announcements <i class="fa fa-arrow-right"></i>
								</button>
							</div>
						</div>
					</div>
							...
							<div class="panel-body">
								<ul class="media-list user-list">
									...
									<li class="media">
										...
										<div class="media-body">
											<h4 class="media-heading nomargin">
												<a href="">Roberta F. Horn</a>
											</h4>
											commented on <a href="">HTML5 Tutorial</a> <small
												class="date"><i class="glyphicon glyphicon-time"></i>
												Yesterday</small>
										</div>
									</li>
									<li class="media">
										...
										<div class="media-body">
											<h4 class="media-heading nomargin">
												<a href="">Jennie S. Gray</a>
											</h4>
											posted a video on <a href="">The Discovery</a> <small
												class="date"><i class="glyphicon glyphicon-time"></i>
												June 25, 2015</small>
										</div>
									</li>
